/**
 * EEP A5-02-16: Temperature Sensor (0°C to +80°C)
 */
...
export const a50216 = {
  meta: {
    ...
    func: "02",
    type: "16",
    title: "Temperature Sensor (0°C to +80°C)",
    status: "released",
  },
  profile: () => ({
    type: "sensor",
    readings: [
      { name: "temperature", type: "number", unit: "°C", min: 0, max: 80 },
    ],
  }),
  decode: (payload) => {
    ...
    return {
      temperature: parseFloat(
        scale(rawTemperature, [255, 0], [0, 80]).toFixed(1)
      ),
      learnBit,
    };
  },
  encode: (data) => {
    ...
    const rawTemperature = Math.round(
      scale(data.temperature, [0, 80], [255, 0])
    );
