// ***********************************************************
// this parser is broken!!!!!!!!! DON'T USE IT !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
import { toCRC8 } from '../../crc8/src/crc8.js'
import * as CONST from './parser-const.js'

const Transform = require('stream').Transform
// this is the fasted parser, but with a different interface. do not use it...
class ESP3OptimizedParser extends Transform {
    ...
    for (let offset = 0; offset < chunk.length; offset++) {
      ...
      switch (this.state) {
        ...
        case CONST.CHECK_CRC8_HEADER:
          this.currentESP3Packet.push(byte)
          if (!(this.currentESP3Packet.slice(1, 5).reduce(toCRC8, 0) === byte)) {
          ...
          if (this.currentESP3Packet[1] * 16 + this.currentESP3Packet[2] + this.currentESP3Packet[3] <= 0) {
            this.emit('error', {
        ...
        case CONST.FILL_DATA_OPTIONALDATA:
          ...
          l = this.currentESP3Packet[1] * 16 + this.currentESP3Packet[2] + this.currentESP3Packet[3] + 6
          if (this.currentESP3Packet.length < l) {
            break
          }
        ...
        case CONST.CHECK_CRC8_DATAS:
          this.currentESP3Packet.push(byte)
          this.state = CONST.WAIT_FOR_SYNC_BYTE
          if (!(this.currentESP3Packet.slice(6, l).reduce(toCRC8, 0) === byte)) {
            this.emit('error', {
              code: 2,
...
export default ESP3OptimizedParser
