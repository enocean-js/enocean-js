"main";_ca9‍.x([["default",()=>Response]]);let ESP3Packet;_ca9‍.w("../ESP3Packet",[["default",["ESP3Packet"],function(v){ESP3Packet=v}]]);let emptyPacket;_ca9‍.w("../EmptyPacketStructure.js",[["default",["emptyPacket"],function(v){emptyPacket=v}]]);


               class Response extends ESP3Packet {
  constructor (esp3Packet = emptyPacket) {
    esp3Packet.header.packetType = 0x02
    super(esp3Packet)
