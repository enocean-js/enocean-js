"main";_981‍.x([["default",()=>CommonCommand]]);let ESP3Packet;_981‍.w("../ESP3Packet",[["default",["ESP3Packet"],function(v){ESP3Packet=v}]]);let emptyPacket;_981‍.w("../EmptyPacketStructure.js",[["default",["emptyPacket"],function(v){emptyPacket=v}]]);


               class CommonCommand extends ESP3Packet {
  constructor (esp3Packet = emptyPacket) {
    esp3Packet.header.packetType = 0x05
    super(esp3Packet)
    const commandTypes = [
