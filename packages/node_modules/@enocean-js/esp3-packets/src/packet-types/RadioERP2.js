...
class RadioERP2 extends ESP3Packet {
  get addressControl(){
    let ctrl = [{src:3,dest:0},{src:4,dest:0},{src:4,dest:4},{src:6,dest:0}]
  ...
  get payload(){
    ...
    os+=ac.src+ac.dest
    let l = this.data.length - (os + this.optionalDL)
  ...
  get RORG() {
    let rorgs = [0xf6,0xd5,0xa5,0xd0,0xd2,0xd4,0xd1,0x30,0x31,0x35,0xb3,null,null,null,null,"extended"]
    let extRorgs = [0xc5,0xc6,0xc7,0x40,0x32,0xb0,0xb1,0xb2]
    if(this.telegramType === 0b1111){
      extRorgs[super.data[2]]
    }
  ...
  static from (input) {
    ...
    if (Object.prototype.hasOwnProperty.call(input, 'payload')) {
      ...
      var res = new RadioERP2(super.from(input).toString())
      return res
    }
  }
}
