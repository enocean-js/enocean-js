...
a&&0<b});if(0<b){for(this.state=FILL_HEADER;0<b;)this.currentESP3Packet.shift(),b--;break}console.warn("WRONG_HEADER_CHECKSUM_ERROR");this.currentESP3Packet=[];this.state=WAIT_FOR_SYNC_BYTE;break}if(0>=this.getDataLength()+this.currentESP3Packet[3]){console.warn("ILLEGAL_PACKET_LENGTH_ERROR");this.currentESP3Packet=[];this.state=WAIT_FOR_SYNC_BYTE;break}this.currentESP3Packet.push(b);this.state=FILL_DATA_OPTIONALDATA;break;case FILL_DATA_OPTIONALDATA:this.currentESP3Packet.push(b);if(this.currentESP3Packet.length>
this.maxBufferSize){this.currentESP3Packet=[];this.state=WAIT_FOR_SYNC_BYTE;console.warn("BUFFER_OVERFLOW_ERROR");break}if(this.currentESP3Packet.length<this.getDataLength()+this.currentESP3Packet[3]+6)break;this.state=CHECK_CRC8_DATAS;break;case CHECK_CRC8_DATAS:this.state=WAIT_FOR_SYNC_BYTE,this.currentESP3Packet.slice(6).reduce(toCRC8,0)!==b?console.warn("WRONG_BODY_CHECKSUM"):(this.currentESP3Packet.push(b),this.emitter.data(this.currentESP3Packet))}}};
