...
class RadioERP1 extends ESP3Packet {
  ...
  static makeTeachIn (opt) {
    var input = { ...{ eep: 'a5-02-01', manufacturerId: 0x7FF, bidi: 0, cmd: UTE_CMD_QUERY, destinationId: 'ffffffff', senderid: '00000000', responseRequired: 0, requestPayload: null, result: 1 }, ...opt }
    var pl
    ...
    if (input.hasOwnProperty('eep')) {
      switch (rorg) {
        ...
        default:
          ...
          pl.setValue(input.manufacturerId || 0x7ff, 13, 10) // manufacturer
          return RadioERP1.from({
