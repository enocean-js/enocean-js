...
class RadioERP1 extends ESP3Packet {
  ...
  static makeTeachIn (opt) {
    var input = { ...{ eep: 'a5-02-01', manufacturerId: 0x0, bidi: 0, cmd: UTE_CMD_QUERY, destinationId: 'ffffffff', senderid: '00000000', responseRequired: 0, requestPayload: null, result: 1 }, ...opt }
    var pl
