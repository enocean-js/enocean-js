...
class RadioERP1 extends ESP3Packet {
  ...
  static makeTeachIn (opt) {
    const input = { ...{ eep: 'a5-02-01', manufacturerId: 0x7FF, bidi: 0, cmd: UTE_CMD_QUERY, destinationId: 'ffffffff', senderId: '00000000', responseRequired: 0, requestPayload: null, result: 1, channels: 0xff }, ...opt }
    let pl
