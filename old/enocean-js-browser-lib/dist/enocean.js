...
// ../eep-transcoder/utils/utils.js
var utils_exports = {};
__export(utils_exports, {
  decodeA5TeachIn: () => decodeA5TeachIn,
  decodeValueFromRangeMap: () => decodeValueFromRangeMap,
  encodeA5TeachIn: () => encodeA5TeachIn,
  encodeTeachIn: () => encodeTeachIn,
  encodeValueFromRangeMap: () => encodeValueFromRangeMap,
  fromString: () => fromString,
  getManufacturerIdByName: () => getManufacturerIdByName,
  getManufacturerNameById: () => getManufacturerNameById,
  getValue: () => getValue,
  scale: () => scale,
  setSingleBit: () => setSingleBit,
  setValue: () => setValue,
  toString: () => toString
});

// ../eep-transcoder/utils/byte-helpers.js
function getValue(byteArray, bitOffset, bitLength) {
  if (bitLength === 0) return 0;
...
function setValue(byteArray, value, bitOffset, bitLength) {
  const bits = value.toString(2).padStart(bitLength, "0");
...
function setSingleBit(byteArray, bitOffset, value) {
...
function toString(byteArray, radix = 16) {
...
function fromString(str, radix = 16) {
  const bytes = [];
  switch (radix) {
    case "bin":
    case 2:
...
// ../eep-transcoder/utils/scale.js
function scale(value, fromRange, toRange) {
  return (value - fromRange[0]) * (toRange[1] - toRange[0]) / (fromRange[1] - fromRange[0]) + toRange[0];
}

// ../eep-transcoder/utils/manufacturer.js
var manufacturerList = [
  { id: 0, name: "MANUFACTURER_RESERVED" },
  { id: 1, name: "PEHA" },
  { id: 2, name: "THERMOKON" },
  { id: 3, name: "SERVODAN" },
  { id: 4, name: "ECHOFLEX_SOLUTIONS" },
  { id: 5, name: "OMNIO_AG or AWAG_ELEKTROTECHNIK_AG" },
  { id: 6, name: "HARDMEIER_ELECTRONICS" },
  { id: 7, name: "REGULVAR_INC" },
  { id: 8, name: "AD_HOC_ELECTRONICS" },
  { id: 9, name: "DISTECH_CONTROLS" },
  { id: 10, name: "KIEBACK_AND_PETER" },
  { id: 11, name: "ENOCEAN_GMBH" },
  { id: 12, name: "PROBARE or VICOS_GMBH" },
  { id: 13, name: "ELTAKO" },
  { id: 14, name: "LEVITON" },
  { id: 15, name: "HONEYWELL" },
  { id: 16, name: "SPARTAN_PERIPHERAL_DEVICES" },
  { id: 17, name: "SIEMENS" },
  { id: 18, name: "T_MAC" },
  { id: 19, name: "RELIABLE_CONTROLS_CORPORATION" },
  { id: 20, name: "ELSNER_ELEKTRONIK_GMBH" },
  { id: 21, name: "DIEHL_CONTROLS" },
  { id: 22, name: "BSC_COMPUTER" },
  { id: 23, name: "S_AND_S_REGELTECHNIK_GMBH" },
  { id: 24, name: "ZENO_CONTROLS or MASCO_CORPORATION" },
  { id: 25, name: "INTESIS_SOFTWARE_SL" },
  { id: 26, name: "VIESSMANN" },
  { id: 27, name: "LUTUO_TECHNOLOGY" },
  { id: 28, name: "CAN2GO" },
  { id: 29, name: "SAUTER" },
  { id: 30, name: "BOOT_UP" },
  { id: 31, name: "OSRAM_SYLVANIA" },
  { id: 32, name: "UNOTECH" },
  { id: 33, name: "DELTA_CONTROLS_INC" },
  { id: 34, name: "UNITRONIC_AG" },
  { id: 35, name: "NANOSENSE" },
  { id: 36, name: "THE_S4_GROUP" },
  { id: 37, name: "MSR_SOLUTIONS or VEISSMANN_HAUSATOMATION_GMBH" },
  { id: 38, name: "GE" },
  { id: 39, name: "MAICO" },
  { id: 40, name: "RUSKIN_COMPANY" },
  { id: 41, name: "MAGNUM_ENERGY_SOLUTIONS" },
  { id: 42, name: "KMC_CONTROLS" },
  { id: 43, name: "ECOLOGIX_CONTROLS" },
  { id: 44, name: "TRIO_2_SYS" },
  { id: 45, name: "AFRISO_EURO_INDEX" },
  { id: 46, name: "WALDMANN_GMBH" },
  { id: 48, name: "NEC_PLATFORMS_LTD" },
  { id: 49, name: "ITEC_CORPORATION" },
  { id: 50, name: "SIMICX_CO_LTD" },
  { id: 51, name: "PERMUNDO_GMBH" },
  { id: 52, name: "EUROTRONIC_TECHNOLOGY_GMBH" },
  { id: 53, name: "ART_JAPAN_CO_LTD" },
  { id: 54, name: "TIANSU_AUTOMATION_CONTROL_SYSTE_CO_LTD" },
  { id: 55, name: "WEINZIERL_ENGINEERING_GMBH" },
  { id: 56, name: "GRUPPO_GIORDANO_IDEA_SPA" },
  { id: 57, name: "ALPHAEOS_AG" },
  { id: 58, name: "TAG_TECHNOLOGIES" },
  { id: 59, name: "WATTSTOPPER" },
  { id: 60, name: "PRESSAC_COMMUNICATIONS_LTD" },
  { id: 62, name: "GIGA_CONCEPT" },
  { id: 63, name: "SENSORTEC" },
  { id: 64, name: "JAEGER_DIREKT" },
  { id: 65, name: "AIR_SYSTEM_COMPONENTS_INC" },
  { id: 66, name: "ERMINE_CORP" },
  { id: 67, name: "SODA_GMBH" },
  { id: 68, name: "EKE_AUTOMATION" },
  { id: 69, name: "HOLTER_REGELARMUTREN" },
  { id: 70, name: "ID_RF" },
  { id: 71, name: "DEUTA_CONTROLS_GMBH" },
  { id: 72, name: "EWATTCH" },
  { id: 73, name: "MICROPELT" },
  { id: 74, name: "CALEFFI_SPA" },
  { id: 75, name: "DIGITAL_CONCEPTS" },
  { id: 76, name: "EMERSON_CLIMATE_TECHNOLOGIES" },
  { id: 77, name: "ADEE_ELECTRONIC" },
  { id: 78, name: "ALTECON" },
  { id: 79, name: "NANJING_PUTIAN_TELECOMMUNICATIONS" },
  { id: 80, name: "TERRALUX" },
  { id: 81, name: "MENRED" },
  { id: 82, name: "IEXERGY_GMBH" },
  { id: 83, name: "OVENTROP_GMBH" },
  { id: 84, name: "BUILDING_AUTOMATION_PRODUCTS_INC" },
  { id: 85, name: "FUNCTIONAL_DEVICES_INC" },
  { id: 86, name: "OGGA" },
  { id: 87, name: "ITHO_DAALDEROP" },
  { id: 88, name: "RESOL" },
  { id: 89, name: "ADVANCED_DEVICES" },
  { id: 90, name: "AUTANI_LCC" },
  { id: 91, name: "DR_RIEDEL_GMBH" },
  { id: 92, name: "HOPPE_HOLDING_AG" },
  { id: 93, name: "SIEGENIA_AUBI_KG" },
  { id: 94, name: "ADEO_SERVICES" },
  { id: 95, name: "EIMSIG_EFP_GMBH" },
  { id: 96, name: "VIMAR_SPA" },
  { id: 97, name: "GLEN_DIMLAX_GMBH" },
  { id: 98, name: "PMDM_GMBH" },
  { id: 99, name: "HUBBEL_LIGHTNING" },
  { id: 100, name: "DEBFLEX" },
  { id: 101, name: "PERIFACTORY_SENSORSYSTEMS" },
  { id: 102, name: "WATTY_CORP" },
  { id: 103, name: "WAGO_KONTAKTTECHNIK" },
  { id: 104, name: "KESSEL" },
  { id: 105, name: "AUG_WINKHAUS" },
  { id: 106, name: "DECELECT" },
  { id: 107, name: "MST_INDUSTRIES" },
  { id: 108, name: "BECKER_ANTRIEBE" },
  { id: 109, name: "NEXELEC" },
  { id: 110, name: "WIELAND_ELECTRIC" },
  { id: 111, name: "AVIDSEN" },
  { id: 112, name: "CWS_BOCO_INTERNATIONAL" },
  { id: 113, name: "ROTO_FRANK" },
  { id: 114, name: "ALM_CONTORLS" },
  { id: 115, name: "TOMMASO_TECHNOLOGIES" },
  { id: 116, name: "REHAU" },
  { id: 2047, name: "MULTI_USER_MANUFACTURER" }
];
...
function getManufacturerIdByName(name) {
  ...
  return entry ? entry.id : 2047;
}

// ../eep-transcoder/utils/range-map.js
function decodeValueFromRangeMap(rawValue, rangeMap) {
...
function encodeValueFromRangeMap(key, rangeMap, defaultValue = null) {
...
// ../eep-transcoder/utils/teach-in.js
function encodeTeachIn({ eep, manufacturer: manufacturer2 = 2047 }) {
  const rorg = eep.split("-")[0];
  switch (rorg) {
    case "a5":
      return encodeA5TeachIn({ eep, manufacturer: manufacturer2 });
    default:
      return null;
  }
}
function encodeA5TeachIn({ eep, manufacturer: manufacturer2 = 2047 }) {
  const [, func, type] = eep.split("-").map((x) => parseInt(x, 16));
  let payload = new Uint8Array(4);
  let manId = 2047;
  if (typeof manufacturer2 == "string") {
    manId = getManufacturerIdByName(manufacturer2);
  } else {
    manId = manufacturer2;
  }
...
function decodeA5TeachIn(payload) {
  ...
  const lrnBit = getValue(payload, 28, 1);
  return {
    eep: `a5-${func.toString(16).padStart(2, "0")}-${typ.toString(16).padStart(2, "0")}`,
...
function extractRangeValue(rawValue, datafield, array, payload) {
  ...
  let scale2 = datafield.scale;
  let range = datafield.range;
  if ("ref" in datafield.scale) {
    scale2 = getRefField(datafield.scale.ref, array, payload).scale;
  }
  if ("ref" in datafield.range) {
    range = getRefField(datafield.range.ref, array, payload).range;
  }
  return mapValue(rawValue, range, scale2);
}
function mapValue(value, range, scale2) {
  const rangeDistance = Number(range.max) - Number(range.min);
  const scaleDistance = Number(scale2.max) - Number(scale2.min);
  const dx = scaleDistance / rangeDistance;
  return (value - Number(range.min)) * dx + Number(scale2.min);
}
...
function setRangeValue(rawValue, datafield, eep, payload) {
  ...
  let range = datafield.range;
  if ("ref" in datafield.scale) {
    scale2 = getRefField(datafield.scale.ref, eep, payload).scale;
  }
  if ("ref" in datafield.range) {
    range = getRefField(datafield.range.ref, eep, payload).range;
  }
  return mapValue(rawValue, scale2, range);
}
...
var RadioERP2 = class _RadioERP2 extends ESP3Packet {
  ...
  get RORG() {
    ...
    return rorgs2[this.telegramType];
  }
  get subTelNum() {
    return super.optionalData[0];
  }
...
function getRorgTitle(rorg) {
  const entry = rorgs.find((item) => item.rorg === rorg);
  return entry ? entry.title : void 0;
}
